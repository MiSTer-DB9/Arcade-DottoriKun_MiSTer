...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-DottoriKun_MiSTer.git"
CORE_NAME=(Arcade-DottoriKun)
...
UPSTREAM_CORE_NAME=(Arcade-DottoriKun)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-DottoriKun.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-DottoriKun.rbf)
